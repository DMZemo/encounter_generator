...
def set_encounter_ratings():
    ...
    update_encounter_text(f"\nHumanoid ER: {humanoid_er} Fauna ER: {fauna_er} Flora ER: {flora_er}\n")
...
set_encounter_ratings_button = Button(window, text="Set Encounter Ratings", command=set_encounter_ratings)
